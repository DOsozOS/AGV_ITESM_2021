...
data_line_count = 0
line_count = 0
filename =  'PATH_FOLLOW_TEST_2021-05-04_16:45:47.604642_SIMULATION'
filename2 = 'saved_route_3'
...
with open("SIMULATION_FILES/"+filename+".csv") as csv_file:
...
ax.legend(handles=[KF,DESIRED_PATH,arrow,GPS],loc='upper left',ncol=3, mode="expand", borderaxespad=0.0)
