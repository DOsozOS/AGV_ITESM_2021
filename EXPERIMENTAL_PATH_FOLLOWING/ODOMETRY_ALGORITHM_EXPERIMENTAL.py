...
def YAW_CALLBACK(message):
    ...
    #CALIBRATE YAW IMU BEFOR ANYTHING! HELP YOUR SELF FROM YOUR CELPHONE COMPASS. NOTICE IN THE THESIS DOCUMENT THE 
    #DEFAULT ORIENTATION AND MAKE THE NECESSARY OPERATIONS.
